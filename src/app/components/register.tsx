...
export function Register() {
  ...
  const canProceed = name.trim().length > 0 && isValidEmail;
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-[#0F172A] border rounded-xl py-3 pl-12 pr-4 text-[#F1F5F9] placeholder:text-[#F1F5F9]/30 focus:outline-none transition-colors ${
                  ...
                  {email.length > 0 && !isValidEmail && (
                    <p className="text-red-400 text-xs mt-2">Por favor, ingresa un correo electrónico válido.</p>
                  )}
                </div>
              </div>
            </div>
